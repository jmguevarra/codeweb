...
public class HtmlDetailedLesson extends AppCompatActivity {
   ...
   /* TextView titletext;*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getting serialized data in the parent activity
        if(getIntent().getSerializableExtra("data") != null && getIntent().getSerializableExtra("student") != null){
            ...
            Picasso.with(HtmlDetailedLesson.this)
            ...
            public void onClick(View view){
                if(finish.equalsIgnoreCase("finish")){
                    if(data.lsn_no == load.size()){
                        if(lsn_id == 3){
                            Toast.makeText(HtmlDetailedLesson.this, "There's no more", Toast.LENGTH_SHORT).show();
                            Intent  in = new Intent(HtmlDetailedLesson.this, HtmlFunActivity.class);
                            in.putExtra("data", userData);
                            startActivity(in);
                        }else{
                            Intent in = new Intent(HtmlDetailedLesson.this, HtmlLessonPanel.class);
                            in.putExtra("data", userData);
                        ...
                        Intent in = new Intent(HtmlDetailedLesson.this, HtmlDetailedLesson2.class);
                        ...
                        HtmlDetailedLesson.super.onBackPressed();
                        startActivity(in);
                    }
                    ...
                    if(data.lsn_no == userData.User_level || (data.lsn_no == load.size() && data.lsn_no == userData.User_level)) {
                        Intent in = new Intent(HtmlDetailedLesson.this, QuestActivity.class);
                        in.putExtra("student", userData);
                        in.putExtra("id", lsn_id);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_about) {
            Intent in = new Intent(HtmlDetailedLesson.this, AboutUs.class);
            startActivity(in);
            return true;
   ...
   /* public void BackBtn(View view){
    ...
    public void gotoVideoSite(View view){
        if(data.lsn_video.isEmpty()){
            ...
            Intent in  = new Intent(HtmlDetailedLesson.this, VideoPanel.class);
            in.putExtra("data", data);
            startActivity(in);
        }
    }
    ...
    public void gotoCodeEditor(View view){
        Intent in  = new Intent(HtmlDetailedLesson.this, CodeEditor.class);
        startActivity(in);
    }
    ...
    public void AsyncLoad(){
        ...
        PostResponseAsyncTask task = new PostResponseAsyncTask(HtmlDetailedLesson.this, postData, new AsyncResponse() {
            @Override
    ...
    public void toHome(){
        ...
        PostResponseAsyncTask adminData = new PostResponseAsyncTask(HtmlDetailedLesson.this, postData, new AsyncResponse() {
            @Override
            public void processFinish(String s) {
