...
public class JsDetailedLesson2 extends AppCompatActivity {
    SrlLesson data;
   ...
   /* TextView titletext;*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getSerializableExtra("data") != null && getIntent().getSerializableExtra("student") != null) {
            ...
            Picasso.with(JsDetailedLesson2.this)
            ...
            public void onClick(View view) {
                if (finish.equalsIgnoreCase("finish")) {
                    if (data.lsn_no == load.size()) {
                        if (lsn_id == 7) {
                            Toast.makeText(JsDetailedLesson2.this, "There's no more", Toast.LENGTH_SHORT).show();
                            Intent in = new Intent(JsDetailedLesson2.this, JsFunActivity.class);
                            in.putExtra("data", userData);
                            startActivity(in);
                        } else {
                            Intent in = new Intent(JsDetailedLesson2.this, JsLessonPanel.class);
                            in.putExtra("data", userData);
                        ...
                        Intent in = new Intent(JsDetailedLesson2.this, JsDetailedLesson.class);
                        ...
                        JsDetailedLesson2.super.onBackPressed();
                        startActivity(in);
                    }
                    ...
                    if (data.lsn_no == userData.User_level || (data.lsn_no == load.size() && data.lsn_no == userData.User_level)) {
                        Intent in = new Intent(JsDetailedLesson2.this, QuestActivity.class);
                        in.putExtra("student", userData);
                        in.putExtra("id", lsn_id);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_about) {
            Intent in = new Intent(JsDetailedLesson2.this, AboutUs.class);
            startActivity(in);
            return true;
   ...
   /* public void BackBtn(View view) {
    ...
    public void AsyncLoad() {
        ...
        PostResponseAsyncTask task = new PostResponseAsyncTask(JsDetailedLesson2.this, postData, new AsyncResponse() {
            @Override
    ...
    public void gotoVideoSite(View view) {
        if (data.lsn_video.isEmpty()) {
            ...
            Intent in = new Intent(JsDetailedLesson2.this, VideoPanel.class);
            in.putExtra("data", data);
            startActivity(in);
        }
    }
    ...
    public void gotoCodeEditor(View view) {
        Intent in = new Intent(JsDetailedLesson2.this, CodeEditor.class);
        startActivity(in);
    }
    public void toHome(){
        HashMap postData = new HashMap();
        postData.put("adminData", ""+userData.ID);
        PostResponseAsyncTask adminData = new PostResponseAsyncTask(JsDetailedLesson2.this, postData, new AsyncResponse() {
            @Override
            public void processFinish(String s) {
