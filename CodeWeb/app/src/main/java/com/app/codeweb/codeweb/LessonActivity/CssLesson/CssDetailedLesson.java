...
public class CssDetailedLesson extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* titletext = (TextView) findViewById(R.id.titlename);*/
        ...
        if(getIntent().getSerializableExtra("data") != null && getIntent().getSerializableExtra("student") != null){
            ...
            Picasso.with(CssDetailedLesson.this)
            ...
            public void onClick(View view){
                if(finish.equalsIgnoreCase("finish")){
                    if(data.lsn_no == load.size()){
                        if(lsn_id == 7){
                            Toast.makeText(CssDetailedLesson.this, "There's no more", Toast.LENGTH_SHORT).show();
                            Intent in = new Intent(CssDetailedLesson.this, CssFunActivity.class);
                            in.putExtra("data", userData);
                            startActivity(in);
                        }else{
                            Intent in = new Intent(CssDetailedLesson.this, CssLessonPanel.class);
                            in.putExtra("data", userData);
                        ...
                        Intent in = new Intent(CssDetailedLesson.this, CssDetailedLesson2.class);
                        ...
                        CssDetailedLesson.super.onBackPressed();
                        startActivity(in);
                    }
                    ...
                    if(data.lsn_no == userData.User_level || (data.lsn_no == load.size() && data.lsn_no == userData.User_level)) {
                        Intent in = new Intent(CssDetailedLesson.this, QuestActivity.class);
                        in.putExtra("student", userData);
                        in.putExtra("id", lsn_id);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_about) {
            Intent in = new Intent(CssDetailedLesson.this, AboutUs.class);
            startActivity(in);
            return true;
...
/*
    ...
    public void gotoVideoSite(View view){
        if(data.lsn_video.isEmpty()){
            ...
            Intent in  = new Intent(CssDetailedLesson.this, VideoPanel.class);
            in.putExtra("data", data);
            startActivity(in);
        }
    }
    ...
    public void gotoCodeEditor(View view){
        Intent in  = new Intent(CssDetailedLesson.this, CodeEditor.class);
        startActivity(in);
    }
    ...
    public void AsyncLoad(){
        ...
        PostResponseAsyncTask task = new PostResponseAsyncTask(CssDetailedLesson.this, postData, new AsyncResponse() {
            @Override
    ...
    public void toHome(){
        ...
        PostResponseAsyncTask adminData = new PostResponseAsyncTask(CssDetailedLesson.this, postData, new AsyncResponse() {
            @Override
            public void processFinish(String s) {
