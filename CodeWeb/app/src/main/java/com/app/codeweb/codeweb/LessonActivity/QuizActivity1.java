...
public class QuizActivity1 extends AppCompatActivity {
            ...
            next.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (!rb_A.isChecked() && !rb_B.isChecked() && !rb_C.isChecked() && !rb_D.isChecked()) {
                        Toast.makeText(QuizActivity1.this, "Please Tap Your Desired Answer! ", Toast.LENGTH_SHORT).show();
                    } else {
                        if (rb_A.isChecked() && rb_A.getText().toString().equalsIgnoreCase(quiz.quiz_Ans)) {
                            Toast.makeText(QuizActivity1.this, "Correct", Toast.LENGTH_SHORT).show();
                            sound.playCheck();
                            updateScore();
                            ...
                            Toast.makeText(QuizActivity1.this, "Wrong", Toast.LENGTH_SHORT).show();
    ...
    public void updateScore(){
        ...
        PostResponseAsyncTask task = new PostResponseAsyncTask(QuizActivity1.this, postData, new AsyncResponse() {
            @Override
            public void processFinish(String s) {
                if(s.contains("success")){
                    ...
                    Toast.makeText(QuizActivity1.this, R.string.scripts_error, Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(QuizActivity1.this, R.string.went_wrong, Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void Leaving() {
        ...
        builder.setNegativeButton("Exit", new Dialog.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent in = new Intent(QuizActivity1.this, MainActivity.class);
        ...
        PostResponseAsyncTask task = new PostResponseAsyncTask(QuizActivity1.this, postData, new AsyncResponse() {
            ...
            public void processFinish(String s) {
               if(!s.isEmpty()) {
                   ...
                   Intent in = new Intent(QuizActivity1.this, QuizActivity.class);
                ...
                if(s.contains("success")){
                    ...
                    PostResponseAsyncTask task = new PostResponseAsyncTask(QuizActivity1.this, postData, new AsyncResponse() {
                        ...
                        if(!s.isEmpty()){
                            ...
                            if(userData.Category_Level.equalsIgnoreCase("js_Events")){
                                Toast.makeText(QuizActivity1.this, "Yehhheeyyy", Toast.LENGTH_SHORT).show();
                            }else{
                                Toast.makeText(QuizActivity1.this, "New Course Unlocked!.", Toast.LENGTH_SHORT).show();
